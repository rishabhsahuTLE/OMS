...
export default function Dashboard2({ orders, onNavigate }: { orders: OrderRecord[]; onNavigate: NavigateFn }) {
  ...
  return (
    <div style={{ fontFamily: D2_FONT, color: D2.text, background: D2.pageBg }} className="-m-6 min-h-full px-6 pb-20">
      <div className="flex flex-wrap items-start justify-between gap-5" style={{ padding: "28px 0 18px" }}>
        <div>
      ...
      <div style={{ position: "sticky", top: 0, zIndex: 20, background: D2.pageBg, padding: "8px 0 12px", marginBottom: 4 }}>
        <div
          style={{
            background: D2.panelBg,
            border: `1px solid ${D2.panelBorder}`,
            borderRadius: 6,
            padding: "12px 16px",
            display: "flex",
            alignItems: "center",
